...
import { AltWizards} from '../../../typechain';
import * as chain from '../../../helpers/chain';
import * as deploy from '../../../helpers/deploy';
import { AbiCoder } from 'ethers/lib/utils';

describe('AltWizards', function () {
    ...
    before(async function () {
        token = (await deploy.deployContract('AltWizards', [baseURI, originToken, originDomain])) as unknown as AltWizards;
    ...
    describe('General tests', function () {
        it('should be deployed', async function () {
            ...
            expect(await token.originContract()).to.equal(originToken);
            expect(await token.originDomainId()).to.equal(originDomain);
        });
    });
